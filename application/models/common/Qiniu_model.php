...
{
    private $accessKey = "Yf-2Ajl4fFYx1PTu3y2YmorYVXgGWx26__oeEknl";
    private $secretKey = "IXJRGzfgpbMKOeOYU3h2xLFjrWdhlCcKGk9Ku8b0";
    ...
    public function get_upload_token($bucket, $withWater, $token)
    {
        ...
        $args['returnBody'] = '{"imgUrl": "http://image.ly724300.com/$(key)"}'; // 这里要改成自己的域名或其他，上传成功后是返回这个json数据，url就是图片的地址
        $b = json_encode($args);
        $result = array(
